...
class TestSuite(unittest.TestCase):
    ...
    def test_convertToBoolean(self):
        ...
        with self.subTest(name="Normal Input Test"):
            expected_list = [True, False, False, False, False,
                             False, False, False]
    ...
    def test_getStreakProduct(self):
        ...
        with self.subTest(name="180"):
            ...
            actual = task3.getStreakProduct("54912346543439485756", 5, 180)
            self.assertListEqual(expected_list, actual)

        with self.subTest(name="400"):
            expected_list = ["5445", "54451", "51445", "14455", "144551",
                             "4455", "44551", "45514", "514514", "145145",
                             "45145", ]
            actual = task3.getStreakProduct("544514455145145798779789", 6, 400)
            self.assertListEqual(expected_list, actual)

        with self.subTest(name="300"):
            expected_list = []
            actual = task3.getStreakProduct("11111111111111111111111", 3, 300)
            self.assertListEqual(expected_list, actual)
